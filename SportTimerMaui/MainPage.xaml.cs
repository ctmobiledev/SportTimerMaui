...
public partial class MainPage : ContentPage
{
    ...
    private void AdjustForPlatform()
    {
        switch (Device.RuntimePlatform)
        {
            ...
            case Device.Android:
                ...
                break;
            case Device.UWP:
                lblClock.Padding = new Thickness(0, 25, 0, 0);
                break;
        }
    }
    ...
    private void btnStart_Clicked(object sender, EventArgs e)
    {
        ...
        lblGreenLight.BackgroundColor = Color.FromArgb("#FF00FF44");
        lblRedLight.BackgroundColor = Colors.DarkRed;
    }
    ...
    private void btnStop_Clicked(object sender, EventArgs e)
    {
        ...
        lblGreenLight.BackgroundColor = Colors.DarkGreen;
        lblRedLight.BackgroundColor = Colors.Red;
    }
